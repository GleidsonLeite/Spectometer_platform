    ...
    float temperature, float humidity, bool coolerState)
{
  ...
  JsonObject distanceSensor_1 = doc.createNestedObject();
  distanceSensor_1["id"] = "d1";
  distanceSensor_1["v"] = distance1;
  JsonObject distanceSensor_2 = doc.createNestedObject();
  distanceSensor_2["id"] = "d2";
  distanceSensor_2["v"] = distance2;
  JsonObject distanceSensor_3 = doc.createNestedObject();
  distanceSensor_3["id"] = "d3";
  distanceSensor_3["v"] = distance3;
  JsonObject distanceSensor_4 = doc.createNestedObject();
  distanceSensor_4["id"] = "d4";
  distanceSensor_4["v"] = distance4;

  JsonObject temperatureSensor = doc.createNestedObject();
